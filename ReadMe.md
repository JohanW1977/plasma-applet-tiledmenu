...
* Supports:
    * Pin/Favourite apps/files/URLs through the context menu (or by dragging them from dolphin or your brouwser).
    * Resizing (permanently) the size of the menu by Meta + Right Clicking and dragging.
    * Any size tile 1x1, 2x2, 4x4, 4x2, 1x3, etc.
    * Easily edit the background image or color of a tile.
    * Easily edit the background color of the sidebar menu.
